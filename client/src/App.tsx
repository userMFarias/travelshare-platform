    ...
    return (
        <div style={{minHeight: '100vh', backgroundImage: 'url(https://images.unsplash.com/photo-1506929562872-bb421503ef21?w=1920&q=80)', backgroundSize: 'cover', backgroundPosition: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '16px'}}>
                ...
                <div style={{display: 'flex', gap: '16px'}}>
                    <button onClick={() => window.location.href = '/how-it-works'} style={{color: 'white', background: 'none', border: 'none', cursor: 'pointer', fontSize: '14px', fontWeight: '500'}}>How it works</button>
                    <button onClick={() => window.location.href = '/help'} style={{color: 'white', background: 'none', border: '1px solid white', cursor: 'pointer', fontSize: '14px', fontWeight: '500', padding: '6px 16px', borderRadius: '6px'}}>Help</button>
                </div>
            </nav>
